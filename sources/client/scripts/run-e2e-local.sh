...
printf "${YELLOW}Step 1: Verifying backend services...${NC}\n"
...
# Step 2: Setup test data (optional - skip if already set up)
printf "${YELLOW}Step 2: Setting up test data...${NC}\n"
...
printf "${YELLOW}Step 3: Running E2E tests...${NC}\n"
cd "$CLIENT_DIR"
