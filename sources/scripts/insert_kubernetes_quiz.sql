-- =====================================================================
-- Kubernetes Basic Knowledge Quiz - 10 Questions
-- Converted from test_data.json
-- Topic: Kubernetes fundamentals, architecture, networking, and operations
-- =====================================================================
...
SELECT
    ...
    is_remedial
FROM questions
WHERE skill_tag LIKE 'kubernetes%'
ORDER BY id DESC
LIMIT 10;

-- Summary by skill tag
SELECT
    skill_tag,
...
-- Overall summary
SELECT
    'Kubernetes questions inserted!' AS status,
