...
\noindent\textbf{Trạng thái Triển khai Components:}
...
\indentpar \indentpar Mặc dù gRPC mang lại hiệu năng cao hơn và type-safety tốt hơn (như đã đề cập trong thiết kế ban đầu), nhóm quyết định sử dụng \textbf{REST/HTTP} cho phiên bản hiện tại vì các lý do sau:
