...
\begin{enumerate}[leftmargin=0.7cm]
    \item \textbf{Phase 1 -- Modular Monolith (MVP):} xây dựng monolith có cấu trúc module, áp dụng Clean Architecture \& DIP (Mục~3.3, ADR-3; Mục~3.4) để thuận lợi tách rời.
