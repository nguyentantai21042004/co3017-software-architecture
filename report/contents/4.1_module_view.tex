...
\noindent\textbf{1. User Management Service (PostgreSQL)}
...
\begin{figure}[H]
    ...
    \caption{ERD của User Management Service}
    \label{fig:erd-user-service}
\end{figure}

\noindent\textbf{2. Content Service (PostgreSQL + JSONB)}
...
\begin{figure}[H]
    ...
    \caption{ERD của Content Service}
    \label{fig:erd-content-service}
\end{figure}

\noindent\textbf{3. Learner Model Service (PostgreSQL)}
...
\begin{figure}[H]
    ...
    \caption{ERD của Learner Model Service}
