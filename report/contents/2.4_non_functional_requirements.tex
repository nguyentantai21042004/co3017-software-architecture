...
\hline
\end{tabularx}
\caption{Yêu cầu Hiệu năng (Performance Requirements)}
\label{tab:performance-requirements}
\end{table}
\renewcommand{\arraystretch}{1.0}

\textbf{b. Yêu cầu Khả năng Mở rộng (Scalability Requirements)}%
\renewcommand{\arraystretch}{1.3}
\begin{table}[H]
\centering
\small
...
\hline
\end{tabularx}
\caption{Yêu cầu Khả năng Mở Rộng (Scalability Requirements)}
...
\textbf{c. Yêu cầu Bảo mật (Security Requirements)}%
\renewcommand{\arraystretch}{1.3}
\begin{table}[H]
\centering
\small
...
\hline
\end{tabularx}
\caption{Yêu cầu Bảo mật (Security Requirements)}
\label{tab:security-requirements}
\end{table}
\renewcommand{\arraystretch}{1.0}

\textbf{d. Yêu cầu Độ tin cậy (Reliability Requirements)}%
\renewcommand{\arraystretch}{1.3}
\begin{table}[H]
\centering
\small
...
\hline
\end{tabularx}
\caption{Yêu cầu Độ tin cậy (Reliability Requirements)}
...
\textbf{e. Yêu cầu Khả năng Sử dụng (Usability Requirements)}%
\renewcommand{\arraystretch}{1.3}
\begin{table}[H]
\centering
\small
...
\hline
\end{tabularx}
\caption{Yêu cầu Khả năng Sử dụng (Usability Requirements)}
\label{tab:usability-requirements}
\end{table}
\renewcommand{\arraystretch}{1.0}

\textbf{f. Yêu cầu Tương thích (Compatibility Requirements)}%
\renewcommand{\arraystretch}{1.3}
\begin{table}[H]
\centering
\small
...
\hline
\end{tabularx}
\caption{Yêu cầu Tương thích (Compatibility Requirements)}
\label{tab:compatibility-requirements}
\end{table}
\renewcommand{\arraystretch}{1.0}

\textbf{g. Yêu cầu Giám sát (Monitoring \& Observability Requirements)}%
\renewcommand{\arraystretch}{1.3}
\begin{table}[H]
\centering
\small
...
\hline
\end{tabularx}
\caption{Yêu cầu Giám sát (Monitoring \& Observability Requirements)}
...
\textbf{h. Yêu cầu Tuân thủ (Compliance \& Regulatory Requirements)}%
\renewcommand{\arraystretch}{1.3}
\begin{table}[H]
\centering
\small
...
\hline
\end{tabularx}
\caption{Yêu cầu Tuân thủ (Compliance \& Regulatory Requirements)}
\label{tab:compliance-requirements}
\end{table}
\renewcommand{\arraystretch}{1.0}

\textbf{i. Yêu cầu Phục hồi Thảm hoạ (Disaster Recovery Requirements)}%
\renewcommand{\arraystretch}{1.3}
\begin{table}[H]
\centering
\small
...
\hline
\end{tabularx}
\caption{Yêu cầu Phục hồi Thảm hoạ (Disaster Recovery Requirements)}
\label{tab:disaster-requirements}
\end{table}
\renewcommand{\arraystretch}{1.0}

\textbf{j. Yêu cầu Bảo trì \& Hỗ trợ (Maintenance \& Support Requirements)}%
\renewcommand{\arraystretch}{1.3}
\begin{table}[H]
\centering
\small
...
\hline
\end{tabularx}
\caption{Yêu cầu Bảo trì \& Hỗ trợ (Maintenance \& Support Requirements)}
