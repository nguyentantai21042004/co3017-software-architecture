...
\hline
\textbf{Bên liên quan (Stakeholder)} & \textbf{Vai trò (Role)} & \textbf{Mức độ Quan tâm (Interest)} & \textbf{Mức độ Ảnh hưởng (Influence)} & \textbf{Mối quan tâm chính (Key Concerns)} \\
\hline
Learner (Học sinh) & Người dùng cuối (End User) & Cao & Cao & Trải nghiệm học tập cá nhân hóa, phản hồi nhanh, giao diện thân thiện. \\
\hline
Instructor (Giảng viên) & Người tạo và giám sát nội dung & Cao & Cao & Quản lý nội dung, báo cáo hiệu suất học tập, dễ sử dụng. \\
\hline
Admin (Quản trị viên) & Chủ sở hữu \& vận hành hệ thống & Trung bình & Cao & Bảo mật, chi phí, khả năng mở rộng, triển khai không downtime. \\
\hline
AI Engineer (Kỹ sư AI) & Phát triển mô hình thích ứng & Trung bình & Trung bình & Dễ tích hợp thuật toán mới, giám sát hiệu suất mô hình. \\
\hline
System Architect (Kiến trúc sư) & Thiết kế \& duy trì cấu trúc hệ thống & Trung bình & Cao & Đảm bảo mô-đun hóa, khả năng test, tuân thủ Clean Architecture. \\
\hline
\end{tabularx}
