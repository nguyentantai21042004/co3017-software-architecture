...
% \indentpar \indentpar Chúng tôi sử dụng các công cụ phân tích tĩnh (static analysis) để liên tục đo lường mức độ tuân thủ SOLID.
...
%     \item \textbf{Eventual Consistency vs. Performance}: Chúng ta chọn mô hình Event-Driven cho việc chấm điểm. Điều này tăng hiệu năng (AC3) (phản hồi tức thì $< 500$ms) nhưng đánh đổi bằng tính nhất quán tức thời (Learner Model được cập nhật sau vài giây)
