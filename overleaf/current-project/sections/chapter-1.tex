\section{Introduction - Software Architecture}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{architecture_blocks_3d}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{four_dimensions_architecture}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{architecture_styles_comparison}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{architecture_characteristics_matrix}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{layered_architecture_rules}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{microservices_design_principles}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{software_architecture_laws}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{clean_architecture_diagram}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{architecture_styles_grid}
